...
const decorProducts = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1583847268500-264663a8a972?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: 5,
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-16 bg-[#fafafa]">
      ...
      <div className="mb-16 border-l-4 border-black pl-6">
        ...
        <p className="text-gray-500 mt-2 text-lg tracking-wide uppercase">
          Sajawat ka Saaman
        </p>
      </div>
