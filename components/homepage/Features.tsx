      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative group overflow-hidden rounded-xl bg-[#f8f7f5] flex items-center min-h-[500px]">
          <div className="absolute inset-0 w-full h-full">
            <Image
              src={Feature1} // Replace with sustainable decor image
          ...
          <div className="relative z-10 p-12 max-w-md">
            ...
            <button className="bg-[#a3a895] text-white px-8 py-3 uppercase tracking-widest text-xs font-sans font-bold hover:bg-[#8e9381] transition-colors">
              Shop Now
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative group overflow-hidden rounded-xl bg-[#f3f4f6] flex items-center h-full min-h-[240px]">
            <div className="absolute inset-0 w-full h-full">
              <Image
                src={Feature2} // Replace with sustainable utility image
            ...
            <div className="relative z-10 p-10 max-w-[250px]">
              ...
              <h3 className="text-3xl text-white mb-6">
                Iconic Sustainable Decor
              </h3>
              <button className="text-sm font-bold border-b-2 border-gray-800 pb-1 hover:text-white hover:border-gray-500 transition-all">
                Shop Now
              </button>
            </div>
          </div>
          ...
          <div className="relative group overflow-hidden rounded-xl bg-[#f0f0f0] flex items-center h-full min-h-[240px]">
            <div className="absolute inset-0 w-full h-full">
              <Image
                src={Feature3} // Replace with craft utility image
